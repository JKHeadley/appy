...
gulp.task('seed', [], function() {
  ...
  return RestHapi.generateModels(Mongoose).then(function(result) {
    models = result
      ...
      return server.start(err => {
        ...
        return dropCollections(models)
          ...
          .then(function(result) {
            ...
            permissions = [
              ...
              },
              {
                ...
                description:
                  'Can allow a user to reset their password without a PIN',
                assignScope: [USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN]
              },
              {
                name: 'readUserScope',
          ...
          .then(function(result) {
            ...
            for (let i = 0; i <= 367; i++) {
              promises.push(
                iplocation(faker.internet.ip(), hosts).then(addVisitor)
              )
            }
          ...
          .then(function(result) {
            ...
            return RestHapi.list(models.permission, {}, Log).then(function(
              result
            ) {
              ...
              return Q.all(promises)
                ...
                .then(function(result) {
                  ...
                  let readOnlyExcludedPermissions = permissions
                    ...
                    .filter(function(p) {
                      return !(
                        p.name.includes('read') || p.name.includes('get')
                      )
                    })
                    .map(function(p) {
                      return {
