...
const routes = [
  {
    ...
    component: Documents,
    name: 'Documents',
    meta: { description: 'Your documents', title: 'Documents', requiresAuth: true }
  }, {
    path: '/documents/:_id',
    ...
    meta: { description: 'Details for the selected document', title: 'Document Details', requiresAuth: true }
  }, {
    path: '/documents/create',
    component: DocumentCreate,
    name: 'DocumentCreate',
    meta: { description: 'Create a new document', title: 'Document', requiresAuth: true }
  }
]
